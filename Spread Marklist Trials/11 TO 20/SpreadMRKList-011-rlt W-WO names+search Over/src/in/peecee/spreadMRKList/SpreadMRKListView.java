...
//    table.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
    ...
    table.getColumnModel().getColumn(28).setPreferredWidth(80);
    table.getColumnModel().getColumn(29).setPreferredWidth(200);
    table.getColumnModel().getColumn(29).setHeaderValue("<html>Remarks/<br>Signature");
