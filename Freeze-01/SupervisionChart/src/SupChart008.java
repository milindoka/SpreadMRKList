...
public class SupChart008 extends javax.swing.JFrame {
    /**
	 * 
	 */
...
//	ArrayList<String> BloxArray = new ArrayList<String>();
	public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupChart008().setVisible(true);
            }
        });
    }
...
///////    N O R T H   P A N E L  /////        
        ...
        buttonBlox.addActionListener(new ActionListener() {		
			  public void actionPerformed(ActionEvent arg0) {
				  ...
				  int bloc = 0;
				  for(int i = 5; i < splitBlox.length + 5; i++){
					  SetData2(splitBlox[bloc],0,i);
					  bloc++;
				  }
				  abc = splitBlox.length;
		      }		
     });            
...
//				Show(abc);
        ...
        buttonLoad.addActionListener(new ActionListener() {      
	        ...
	        FileNameExtensionFilter filter = new FileNameExtensionFilter("SupervisionChart", "sup");
