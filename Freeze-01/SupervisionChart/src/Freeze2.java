...
public class Freeze2 extends javax.swing.JFrame {
    /**
	 * 
	 */
    ...
    private int fixedColumns = 1;    //number of columns to be frozen
...
///////    N O R T H   P A N E L  /////        
        ...
        JLabel Label4 = new JLabel("BLOCK NOs.");
      	northPanel.add(Label4);
      	
      	tableBlox = new JTable();
      	tableBlox.setBorder(new LineBorder(new Color(0, 0, 0), 2));
      	tableBlox.setModel(new DefaultTableModel(
    			new Object[][] {
      	...
      	for(int i = 0; i < 6; i++){
      		tableBlox.setRowHeight(i,18);     // To Set the Height of row to 25 in table_2 Blocks for FYJC
      		tableBlox.getColumnModel().getColumn(i).setPreferredWidth(45);
      	}
      	northPanel.add(tableBlox);
